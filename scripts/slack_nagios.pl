...
#my $opt_domain = "dnm-content.slack.com"; # Your team's domain
#my $opt_token = "hVarxyqyJl0iHZJoZ5nrZTBn"; # The token from your Nagios services page


my $opt_domain = "ucx.slack.com"; # Your team's domain
my $opt_token = "cRyU5umCno5DqUvQ26rmdToP"; # The token from your Nagios services page
